...
export const IconWheat: React.FC<IconProps> = ({ size = 20, color = 'var(--gold-primary)', className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2v20" />
    <path d="M12 18c-3-1-4-3-4-5 2 0 4 1.5 4 5Z" fill={color} fillOpacity="0.25" />
    <path d="M12 13c-3.5-1-4.5-3-4.5-5 2.2 0 4.5 1.5 4.5 5Z" fill={color} fillOpacity="0.25" />
    <path d="M12 8c-3.5-1-4.5-3-4.5-5 2.2 0 4.5 1.5 4.5 5Z" fill={color} fillOpacity="0.25" />
    <path d="M12 18c3-1 4-3 4-5-2 0-4 1.5-4 5Z" fill={color} fillOpacity="0.25" />
    <path d="M12 13c3.5-1 4.5-3 4.5-5-2.2 0-4.5 1.5-4.5 5Z" fill={color} fillOpacity="0.25" />
    <path d="M12 8c3.5-1 4.5-3 4.5-5-2.2 0-4.5 1.5-4.5 5Z" fill={color} fillOpacity="0.25" />
    <path d="M12 4L9.5 2" />
    <path d="M12 4L14.5 2" />
  </svg>
);
